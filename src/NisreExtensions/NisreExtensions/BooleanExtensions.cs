...
namespace System
{
    ...
    public static class BooleanExtensions
    {
        ...
        /// </summary>
        /// <param name="value">
        ///     if set to <c>true</c> return <paramref name="yesString" /> ;otherwise <paramref name="noString" />
        ///     .
        /// </param>
        ...
        {
            if (yesString.IsNullOrEmpty()) yesString = Resource.Yes;
            if (noString.IsNullOrEmpty()) noString = Resource.No;
