namespace System
{
    ...
    public static class EnumExtensions
    {
        ...
        /// <summary>
        ///     Indicates whether the specified enum value and the specified byte have the same value(Ignore case during the
        ///     comparison).
        /// </summary>
        /// <param name="enum">The enum to test.</param>
        /// <param name="value">The byte value to compare to the <paramref name="enum" />.</param>
        ...
        public static bool Equals(this Enum @enum, string value)
        {
            ...
            try
            {
                return @enum.ToString().ToLower() == value.Trim().ToLower();
            }
            catch
            {
                return false;
